...
// * URL's for FlickrClient. The constant values below were taken from
...
//private let _fileURL: NSURL = _documentsDirectoryURL.URLByAppendingPathComponent("FlickrClient-Context")
//
//
...
////        self.init()
////
////        if let imageDictionary = dictionary[FlickrClient.Keys.ConfigImages] as? [String : AnyObject] {
////
////            if let urlString = imageDictionary[FlickrClient.Keys.ConfigBaseImageURL] as? String {
////                baseImageURLString = urlString
////            } else {return nil}
////
////            if let secureUrlString = imageDictionary[FlickrClient.Keys.ConfigSecureBaseImageURL] as? String {
////                secureBaseImageURLString = secureUrlString
////            } else {return nil}
////
////            if let posterSizesArray = imageDictionary[FlickrClient.Keys.ConfigPosterSizes] as? [String] {
////                posterSizes = posterSizesArray
////            } else {return nil}
////
////            if let profileSizesArray = imageDictionary[FlickrClient.Keys.ConfigProfileSizes] as? [String] {
...
////                FlickrClient.sharedInstance().config.save()
////            }
////        }
////    }
//
